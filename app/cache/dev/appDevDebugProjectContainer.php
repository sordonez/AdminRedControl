...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'registronetbook.form.type.detallemovimiento' => 'getRegistronetbook_Form_Type_DetallemovimientoService',
    ...
    {
        $a = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'\\src\\Registronetbook\\ControlBundle\\Resources\\config\\doctrine') => 'Registronetbook\\ControlBundle\\Entity', ($this->targetDirs[3].'\\src\\Registronetbook\\UserBundle\\Resources\\config\\doctrine') => 'Registronetbook\\UserBundle\\Entity'));
        $a->setGlobalBasename('mapping');

        $b = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $b->addDriver($a, 'Registronetbook\\ControlBundle\\Entity');
        $b->addDriver($a, 'Registronetbook\\UserBundle\\Entity');

        $c = new \Doctrine\ORM\Configuration();
        $c->setEntityNamespaces(array('ControlBundle' => 'Registronetbook\\ControlBundle\\Entity', 'UserBundle' => 'Registronetbook\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_fdf1aec9f64f7f7136a5b651fd64a96fd264d23e2fff8ad31217a71334e9b7da');
    ...
    {
        return $this->services['knp_menu.renderer.twig'] = new \Knp\Menu\Renderer\TwigRenderer($this->get('twig'), 'ControlBundle:Menu:menu.html.twig', $this->get('knp_menu.matcher'), array());
    }
    ...
    /**
     * Gets the 'registronetbook.form.type.detallemovimiento' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Registronetbook\ControlBundle\Form\Type\DetalleMOvimientoType A Registronetbook\ControlBundle\Form\Type\DetalleMOvimientoType instance.
     */
    protected function getRegistronetbook_Form_Type_DetallemovimientoService()
    {
        return $this->services['registronetbook.form.type.detallemovimiento'] = new \Registronetbook\ControlBundle\Form\Type\DetalleMOvimientoType();
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Registronetbook\\UserBundle\\Entity\\AppUser' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\PlaintextPasswordEncoder', 'arguments' => array(0 => false))));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('sebas.29.8@gmail.com');
        $a->setPassword('voluntad');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\Registronetbook\\ControlBundle/Resources/views'), 'Control');
        $instance->addPath(($this->targetDirs[3].'\\src\\Registronetbook\\UserBundle/Resources/views'), 'User');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('7d2c83b335510955ad0a1990099e321f7adabf45');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('555a7421f0101'), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.our_db_provider'), new \Symfony\Component\Security\Core\User\UserChecker(), 'secured_area', $this->get('security.encoder_factory'), true)), true);
    ...
    {
        return $this->services['security.user.provider.concrete.our_db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'Registronetbook\\UserBundle\\Entity\\AppUser', 'username', NULL);
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'ControlBundle' => 'Registronetbook\\ControlBundle\\ControlBundle',
                'KnpMenuBundle' => 'Knp\\Bundle\\MenuBundle\\KnpMenuBundle',
                'UserBundle' => 'Registronetbook\\UserBundle\\UserBundle',
            ...
            'mailer_host' => NULL,
            'mailer_user' => 'sebas.29.8@gmail.com',
            'mailer_password' => 'voluntad',
            'locale' => 'en',
            'secret' => '7d2c83b335510955ad0a1990099e321f7adabf45',
            ...
            'kernel.secret' => '7d2c83b335510955ad0a1990099e321f7adabf45',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'sebas.29.8@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'voluntad',
            ...
            'knp_menu.renderer.twig.template' => 'ControlBundle:Menu:menu.html.twig',
