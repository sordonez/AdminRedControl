...
/* ControlBundle:Maquina:show.html.twig */
class __TwigTemplate_681b9921ede1337c39d10305a7273d0ef6dc64c70345818ecf43194858706b81 extends Twig_Template
{
    ...
    <li>
        <a href=\"";
        // line 46
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("admin_maquina_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : $this->getContext($context, "entity")), "id", array()))), "html", null, true);
        echo "\">
            Edit
        </a>
    </li>
...
";
    ...
    {
        return "ControlBundle:Maquina:show.html.twig";
    }
