...
class DetalleMovimiento
{
    ...
    /**
     * @var \Registronetbook\UserBundle\Entity\Orden
     *
     * @ORM\ManyToOne(targetEntity="Registronetbook\UserBundle\Entity\Orden")
     * @ORM\JoinColumns({
    ...
    */
     ...
     * @return DetalleMovimiento
     */
    public function setOrden(\Registronetbook\ControlBundle\Entity\Orden $orden = null)
    {
        $this->orden = $orden;
